...
def is_valid_sequence(dna):
    ...
    Parameter could be DNA sequence.
    Return True if and only if the DNA sequence 
    is valid (contains only characters 'A', 'T', 'C', 'G')
    
    >>> is_valid_sequence("ATTCCGAATTTT")
    True 
    >>> is_valid_sequence("ATTCCGHHHAATTTT)
    False
    ...
    def insert_sequence(dna1, dna2, i):
        ...
        >>> insert_sequence("ATTCATT", "CGCCCG", 3)
        "ATTCGCCGCATT"
